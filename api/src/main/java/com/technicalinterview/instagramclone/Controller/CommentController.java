...
public class CommentController {
    ...
    public Comments update(@PathVariable int id, @RequestBody Comments comments){
        return commentsService.updateComments(id, comments);
    }

    @DeleteMapping("/delete/{id}")
    public Comments delete(@PathVariable int id){
